...
find_package_handle_standard_args(GTK3 DEFAULT_MSG 
        ...
        GTK3_INCLUDE_DIR GLIB_INCLUDE_DIR GLIBCONFIG_INCLUDE_DIR
        PANGO_INCLUDE_DIR CAIRO_INCLUDE_DIR GDK_PIXBUF_INCLUDE_DIR
        ATK_INCLUDE_DIR)

if(GTK3_FOUND)

set(GTK3_INCLUDE_DIRS ${GTK3_INCLUDE_DIR} ${GLIB_INCLUDE_DIR} ${GLIBCONFIG_INCLUDE_DIR} ${PANGO_INCLUDE_DIR} ${CAIRO_INCLUDE_DIR} ${GDK_PIXBUF_INCLUDE_DIR} ${ATK_INCLUDE_DIR} ${HB_INCLUDE_DIR})
set(GTK3_LIBRARIES ${GTK3_LIBRARY} ${GIO_LIBRARY} ${GOBJECT_LIBRARY})
